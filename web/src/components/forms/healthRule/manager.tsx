  ...
  return (
    <DrawerPanelContent isResizable widths={{ default: 'width_50' }} minSize="400px" data-test="health-rules-manager">
      ...
      <DrawerContentBody>
        ...
        {isTemplatesLoading ? (
          <EmptyState variant={EmptyStateVariant.xs} data-test="flowcollector-templates-loading">
            <EmptyStateHeader
          ...
          <EmptyState variant={EmptyStateVariant.xs}>
            <EmptyStateHeader titleText={t('Error')} headingLevel="h4" />
        ...
        {isCustomRulesLoading ? (
          <EmptyState variant={EmptyStateVariant.xs} data-test="custom-prometheus-rules-loading">
            <EmptyStateHeader
          ...
          <EmptyState variant={EmptyStateVariant.xs}>
            <EmptyStateHeader titleText={t('No custom rules')} headingLevel="h4" />
